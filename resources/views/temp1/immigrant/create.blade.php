    ...
    <div class="container">
        <div class="row">
            <div class="col cr-heading">
                ...
                <p>
                    The immigration platform for skilled professionals. 
                </p>
            </div>
        </div>
        <div class="row form">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <span class="d-block">
                            <p>
                                ...
                                <br><br>
                                In order to qualify to immigrate to Canada under the federal skilled worker program, you will need a minimum of 3 years of
                                ...
                                this platform is specifically designed for those immigrating based on their academic qualifications and experience. 
                                <br><br>
