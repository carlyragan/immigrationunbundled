                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            ...
                            <tr>
                                <th scope="row">1</th>
                                <td>{{$row->name}}</td>
                                <td><a href="{{ asset('temp1/files/'.$row->education_credential_assessment) }}" target="_blank">Education Credential Assessment</a> <i class="fa fa-download" aria-hidden="true"></i></td>
                                <td><a href="{{ asset('temp1/files/'.$row->ielts) }}" target="_blank">IELTS Results</a> <i class="fa fa-download" aria-hidden="true"></i></td>
