    ...
    <form class="form-horizontal" method="POST" action="{{ route('immigrant.savestep1') }}">
        ...
        <div class="form-container">
            ...
            <div class="text-center uni-edu">
                <p class="uni-level-para">What level of university education you have completed?</p>
                <span class="d-block">
                ...
                <span class="d-block">
                    ...
                    <label for="applytype5">Master Degree</label>
                </span>
                <span class="d-block">
                    <input type="radio" name="education" id="applytype6" value="d">
                    <label for="applytype6">PH.D</label>
                </span>
            </div>
            ...
            <p class="text-center skils-para">
                ...
                have in one role? <br>
                <small>
                    The work experience doesn't have to match your
            ...
            <div class="spouse-bio" style="display: none;">
                ...
                <p class="text-center skils-para">
                    In the last 10 years how many years of skilled work experience your spouse has? <br>
                </p>
                <div class="d-table w-100 text-center">
                    <span class="d-table-cell">
